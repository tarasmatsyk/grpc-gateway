...
/*
Package echoer is a reverse proxy.
...
func RegisterEchoerHandlerServer(ctx context.Context, mux *runtime.ServeMux, server EchoerServer) error {
	...
	mux.Handle("POST", pattern_Echoer_Echo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/grpc.gateway.echoer.Echoer/Echo")
		if err != nil {
...
func RegisterEchoerHandlerClient(ctx context.Context, mux *runtime.ServeMux, client EchoerClient) error {
	...
	mux.Handle("POST", pattern_Echoer_Echo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/grpc.gateway.echoer.Echoer/Echo")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Echoer_Echo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"grpc.gateway.echoer.Echoer", "Echo"}, ""))
)
